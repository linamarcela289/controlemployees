...
namespace Test.Test
{
    public class ApiTest
    {
        ...
        public async void DeleteEmployee_Should_Return_200()
        {
            ...
            // Act
            IActionResult response = await Api.DeleteEmployee(request, TestFactory.GetEmployeeEntity(), mockEmployee, TestFactory.GetEmployeeEntity().IdEmployee.ToString(), logger);
        ...
        public async void GetAllEmployeeId_Should_Return_200()
        {
            ...
            Employee employeeRequest = TestFactory.GetEmployeeRequest();
            Guid employeeId = Guid.NewGuid();
            DefaultHttpRequest request = TestFactory.GetAllHttpRequestId(employeeId);
